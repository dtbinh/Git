...
#define STEP_SIZE_1 400
#define STEP_SIZE_2 400
#define STEP_SIZE_3 400
#define STEP_SIZE_4 400
...
void declareDeviceParameters()
{
  ...
  translation_parameters.steps_per_revolution = STEP_SIZE_1;
  ...
  rotation_parameters.steps_per_revolution = STEP_SIZE_3;
  ...
  front_gripper_parameters.steps_per_revolution = STEP_SIZE_4;
  ...
  back_gripper_parameters.steps_per_revolution = STEP_SIZE_2;
}
