function plotHoughLines(image, rhoVector, thetaVector)
...
for iLine = 1:nLine
    ...
    rho = rhoVector(iLine);
    theta = thetaVector(iLine);
    
    % If the line is horizontal, there is nothing to calculateTESTE9
    if(theta == 0)
